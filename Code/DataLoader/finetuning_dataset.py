...
class EmbDataset(Dataset):
    def __init__(self,
        ...
        self.smiles_emb_data = list(smiles_emb.main(self.dataset)['SMILES_embedding'])  # return dataset
...
class EmbeddedDataset(BaseDataLoader):
    ...
    def _merge(self):
        self.smiles_dataset['SNP'] = self.snp_dataset
